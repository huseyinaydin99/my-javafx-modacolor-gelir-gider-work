...
public class SampleController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		gelirTarihLabel.setText(df.format(new Date()) + " Bugün");
		giderTarihLabel.setText(df.format(new Date()) + " Bugün");
		gelirCek();
		gelirCekTextlere();
	...
	private void giderCek() {
		...
		tableColumn1.setMinWidth(175);
		TableColumn tableColumn2 = new TableColumn<>("Gider Miktarı");
		tableColumn2.setCellValueFactory(new PropertyValueFactory<TableModelGelir, String>("giderMiktar"));
		tableColumn2.setMinWidth(175);
		TableColumn tableColumn3 = new TableColumn<>("Gider Açıklaması");
	...
	private void gelirCekTextlere() {
		...
		try {
			...
			alert.setTitle("Kayıt Hakkında");
			alert.setHeaderText("Uyarı");
			alert.setContentText(this.kayitIndex + ". nolu kayıt silinmiş bir sonrakine geçin!");
			alert.showAndWait();
			return;
		}
	...
	private void giderCekTextlere() {
		...
		try {
			...
			alert.setTitle("Kayıt Hakkında");
			alert.setHeaderText("Uyarı");
			alert.setContentText(this.kayitIndex2 + ". nolu kayıt silinmiş bir sonrakine geçin!");
			alert.showAndWait();
			return;
		}
	...
	public void gelirKaydet() {
		...
		try {
			...
			alert.setContentText("Hatalı giriş yaptınız lütfen düzeltip tekrar girin!");
			alert.showAndWait();
			return;
		}
		...
		Alert alert = new Alert(AlertType.INFORMATION);
		alert.setTitle("Kayıt Bilgisi");
		alert.setHeaderText("Başarılı (:");
		alert.setContentText("Girdiğiniz gelir kaydı başarılı ile yapıldı!");
		alert.showAndWait();
	...
	public void gelirGuncelle() {
		...
		Alert alert = new Alert(AlertType.INFORMATION);
		alert.setTitle("Güncelleme Bilgisi");
		alert.setHeaderText("Başarılı (:");
		alert.setContentText("Girdiğiniz güncelleme başarılı ile yapıldı!");
		alert.showAndWait();
		gelirCek();
		gelirCekTextlere();
		this.gunlukGelirTopla();
	...
	public void geriGit() {
		if (this.kayitIndex < 0) {
			...
			alert.setContentText("İlk kayda geldiniz");
			alert.showAndWait();
		}
	...
	public void gelirSil() {
		...
		ButtonType buttonTypeTwo = new ButtonType("Hayır");
		...
		if (result.get() == buttonTypeOne) {
			...
			alert2.setHeaderText("Uyarı mesajı!");
			alert2.setContentText("Silme işlemi başarılı!");
			alert2.showAndWait();
			this.kayitIndex--;
			this.alaniTemizle();
		}
	...
	private void gunlukGelirTopla() {
		...
		this.gunTopGelir.setText(String.valueOf(gelirGunlukToplam) + " ₺");
	}
	...
	private void gunlukGiderTopla() {
		...
		this.gunTopGider.setText(String.valueOf(giderGunlukToplam) + " ₺");
	}
